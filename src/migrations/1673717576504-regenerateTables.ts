...
export class regenerateTables1673717576504 implements MigrationInterface {
    name = 'regenerateTables1673717576504'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "albums" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying(100) NOT NULL, "duration" character varying(150) NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "performerId" uuid, CONSTRAINT "PK_838ebae24d2e12082670ffc95d7" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "musics" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying(100) NOT NULL, "duration" character varying(150) NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "genreId" uuid, "performerId" uuid, CONSTRAINT "PK_a2e622f30df5467a860991af728" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "musicsToPlaylists" ("musicsId" uuid NOT NULL, "playlistsId" uuid NOT NULL, CONSTRAINT "PK_a72a51a3945707232502189d470" PRIMARY KEY ("musicsId", "playlistsId"))`);
