...
const ensureAuthIsAdmOrOwnerMiddleware = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const musics = yield musicRepository.createQueryBuilder("musics")
        ...
        .getOne();
    if (!musics) {
        throw new errors_1.AppError("Music not exist", 403);
    }
    if (!musics.isActive) {
...
exports.default = ensureAuthIsAdmOrOwnerMiddleware;
