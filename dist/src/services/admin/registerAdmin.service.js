...
const registerAdminService = (adminData) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const savedAdmin = yield userRepository.save(createdAdmin);
    const response = yield users_1.userRegisterResponseSerializer.validate(savedAdmin, {
        stripUnknown: true,
    });
    return response;
});
exports.default = registerAdminService;
