...
const removeMusicsFromPlaylistsService = (req) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!findMusicOnPlaylist) {
        throw new errors_1.AppError("Music isn't in playlist.", 409);
    }
...
exports.default = removeMusicsFromPlaylistsService;
