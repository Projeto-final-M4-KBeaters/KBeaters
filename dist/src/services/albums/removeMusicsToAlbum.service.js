...
const removeMusicFromAlbumService = (albumID, musicID) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!findAlbum) {
        throw new errors_1.AppError("Album not found.", 404);
    }
    ...
    const newMusics = findAlbum.musics.filter((music) => music.id !== (findMusic === null || findMusic === void 0 ? void 0 : findMusic.id));
    if (!findAlbum.musics.find(music => music.id === (findMusic === null || findMusic === void 0 ? void 0 : findMusic.id))) {
        throw new errors_1.AppError("Music isn't on this album.", 409);
    }
    findAlbum.musics = newMusics;
    yield albumRepository.save(findAlbum);
    const response = yield albums_1.listAlbumResponseSerializer.validate(findAlbum, { stripUnknown: true });
    return response;
});
exports.default = removeMusicFromAlbumService;
